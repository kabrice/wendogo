                ...
                <div className="theme-daisy">
                    <footer id="Footer" className="FunnelFooter ProgressBarActive">
                        ...
                        <div className="FunnelFooter-content">
                            <p> Wendogo.comutilise des cookies pour optimiser votre expérience en ligne. En continuant la navigation sur notre site, vous acceptez l'utilisation des cookies. Pour en savoir plus, consultez la{" "} <span className="CTA link  medium      " title="" data-trackingprefix=""> Politique des cookies </span> . </p>
