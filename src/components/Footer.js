...
<div className="Footer__Container-sc-1adny8q-0 fThLJG styles__Footer-sc-kz84w6-4 icxpqI">
                  ...
                  <div className="Footer__Legal-sc-1adny8q-3 AgRYh">
                    ...
                    <ul className="LegalSocial__SocialLinks-sc-v4d14j-2 bwSQCq">
                      <li>
                        <a aria-label="Wendogo sur Instagram" href="https://www.instagram.com/prettofr/" rel="noreferrer noopener" target="_blank" className="LegalSocial__SocialLink-sc-v4d14j-3 GeNZR">
                      ...
                      <li>
                        <a aria-label="Wendogo sur Facebook" href="https://www.facebook.com/prettofr/" rel="noreferrer noopener" target="_blank" className="LegalSocial__SocialLink-sc-v4d14j-3 GeNZR">
                          <svg height={46} viewBox="0 0 46 46" width={46} xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="LegalSocial__Picto-sc-v4d14j-0 llOyxT">
                      ...
                      <li>
                        <a aria-label="Wendogo sur Twitter" href="https://twitter.com/wendogo?lang=fr" rel="noreferrer noopener" target="_blank" className="LegalSocial__SocialLink-sc-v4d14j-3 GeNZR">
                          <svg height={46} viewBox="0 0 46 46" width={46} xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="LegalSocial__Picto-sc-v4d14j-0 llOyxT">
                      ...
                      <li>
                        <a aria-label="Wendogo sur YouTube" href="https://www.youtube.com/channel/UChCPFwdusUcxzj-f0t2m4UA" rel="noreferrer noopener" target="_blank" className="LegalSocial__SocialLink-sc-v4d14j-3 GeNZR">
                          <svg height={46} viewBox="0 0 46 46" width={46} xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="LegalSocial__Picto-sc-v4d14j-0 llOyxT">
