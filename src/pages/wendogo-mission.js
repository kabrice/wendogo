            ...
            <main className="styles__Main-sc-kz84w6-0 gEFmYD " style={{paddingTop: 80}}>
                <div className="Blocsstyles__Page-sc-1q5awhx-1 dVmdSL">
                    ...
                    <div className="styles__Grid-sc-10gqksz-1 iuHviD styles__Grid-sc-1wzyvpr-3 kLhHpn">
                        ...
                        <h1 className="styles__BaseTypo-sc-198xhmk-0 dEWLNu styles__Title-sc-1wzyvpr-10 fGJAqT"> Simplifier et optimiser vos projets de voyage à l’étranger. </h1>
                        <div className="styles__BaseTypo-sc-198xhmk-0 djwbck styles__Content-sc-1qjc0o4-1 cLBZMY styles__Description-sc-1wzyvpr-2 kkxsWA">
                            <p className="styles__Block-sc-1qjc0o4-0 styles__Paragraph-sc-1qjc0o4-2 ktDrhZ bbNzRf"> Wendogo est la plateforme en ligne dédiée à accompagner les internationaux 
                              dans la réussite de leur projet de voyage, en offrant des outils simples, fiables et transparents pour chaque étape, de la préparation du projet 
                              à l’obtention du visa et au-delà.</p>
                        </div>
