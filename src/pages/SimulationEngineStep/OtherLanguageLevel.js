...
const OtherLanguageLevel = () => {
  ...
  return (
    <SELevelRail title={`Comment évaluer votre niveau en ${user?.selectedOtherSpokenLanguage?.name} ?`} arialLabel="Other Language Level" defaultValue={selectedOtherLanguageLevel}  
