                      ...
                      <div className="Defautstyles__Main-sc-1tnudyr-1 fqCHqA">
                        <div className="Defautstyles__Header-sc-1tnudyr-0 hAkdZW">
                          <div className="styles__Hero-sc-s3dlnp-0 gMynSv">
                            ...
                            <picture>
                              <Image alt="Programme de bourses d'étude : comment déterminer votre projet ?" loading="lazy" src={ScholarshipProgramFRImg} className="styles__Image-sc-s3dlnp-1 oBito" />
                            </picture>
                          </div>
                        </div>
                        <div id="main">
