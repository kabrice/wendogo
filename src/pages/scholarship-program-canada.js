...
import ScholarshipProgramCAImg from '../assets/optimized/scholarship_program_for_canada.webp'
...
function ScholarshipProgramCA(){
    ...
    async function copyTextToClipboard(linkNum) {
      try {
        await navigator.clipboard.writeText("https://wendogo.com/scholarship-program-canada")
    ...
    return <div  className="klmqdo">
            <Head>
              <meta property="og:url"           content="https://wendogo.com/scholarship-program-canada" />
                        ...
                        <div className="Defautstyles__Header-sc-1tnudyr-0 hAkdZW">
                          <div className="styles__Hero-sc-s3dlnp-0 gMynSv">
                            ...
                            <div style={{float : 'right'}} className="ButtonLinkstyles__Anchor-sc-1s2ygn0-2 kuldYh">
                             <Link href="/scholarship-program-france">Cliquer ici pour la version 🇫🇷</Link>
                            </div>
                              ...
                              <div className="BlocAuthorStartstyles__BlocAuthorStart-sc-176st2l-0 oTIGB">
                                ...
                                <div className="SharingLinksstyles__SharingLinks-sc-13jf7g7-0 cuaEfY">
                                  <div className="SharingLinksstyles__SharingLinksDesktop-sc-13jf7g7-2 dAIRMX">
                                    ...
                                    <Link target="_blank" href="https://api.whatsapp.com/send/?text=https://wendogo.com/scholarship-program-canada" >
                                    ...
                                    <div className="Tooltipstyles__TooltipContainer-sc-ynyslw-0 iMhBNO SharingLinksstyles__Tooltip-sc-13jf7g7-4 eUmNLd">
                                    <div onClick={() => helper.openFacebookOnPopup('scholarship-program-canada')} className="fb-xfbml-parse-ignore" rel="noreferrer">
                                      <button className="ButtonLinkstyles__ButtonLink-sc-1s2ygn0-0 iPwlpd">
                                        {facebook}
                                        <div className="ButtonLinkstyles__Anchor-sc-1s2ygn0-2 kuldYh kmzeo"> 
                                        Facebook
                            ...
                            <picture>
                              <Image alt="Programme de bourses d'étude : comment déterminer votre projet ?" loading="lazy" src={ScholarshipProgramCAImg} className="styles__Image-sc-s3dlnp-1 oBito" />
                            </picture>
                          </div>
                        </div>
                        <div id="main">
