            ...
            <main className="styles__Main-sc-kz84w6-0 gEFmYD " style={{paddingTop: 80}}>
                <div className="Blocsstyles__Page-sc-1q5awhx-1 dVmdSL">
                    ...
                    <div className="styles__Grid-sc-10gqksz-1 iuHviD styles__Grid-sc-1wzyvpr-3 kLhHpn">
                        ...
                        <picture>
                            <img alt={HappyGirl}  className="styles__Image-sc-1wzyvpr-4 dJhJuV" loading="lazy" src={HappyGirl} style={{width : 400, height : 'auto'}} />
                        </picture>
                        </div>
                    ...
                    <div className="styles__ImageWrapper-sc-1x6pdn2-6 cdwedw">
                        <img src={Mentorship} alt={Mentorship} className="styles__Image-sc-1x6pdn2-5 hjnNVa" loading="lazy" style={{width : 400, height : 'auto'}} />
                    </div>
                    </div>
                    ...
                    <div className="RowCarouselstyles__ImageWrapper-sc-sn9bq-5 kMxKRQ">
                        <img src={OurPromise} alt={OurPromise} className="RowCarouselstyles__Image-sc-sn9bq-6 iipLPw" loading="lazy"/>
                    </div>
                    </div>
